...
public class PopularBD {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("--- 3. Criando Dispositivos ---");

            // Notebooks
            Dispositivos disp1 = new Dispositivos();
            disp1.setBrand("Dell");
            disp1.setModel("Inspiron 15 3000");
            disp1.setCondicao("Tela quebrada");
            disp1.setCusto(0.0);
            disp1.setPreco(0.0);
            em.persist(disp1);
            ...
            disp2.setCondicao("Teclado com problemas");
            disp2.setCusto(0.0);
            disp2.setPreco(0.0);
            em.persist(disp2);
            ...
            disp4.setCondicao("Bateria com defeito");
            disp4.setCusto(0.0);
            disp4.setPreco(0.0);
            em.persist(disp4);
            ...
            disp5.setCondicao("Tela trincada");
            disp5.setCusto(0.0);
            disp5.setPreco(0.0);
            em.persist(disp5);
            ...
            disp6.setCondicao("Problema no conector de carga");
            disp6.setCusto(0.0);
            disp6.setPreco(0.0);
            em.persist(disp6);
            ...
            disp7.setCondicao("Superaquecimento");
            disp7.setCusto(0.0);
            disp7.setPreco(0.0);
            em.persist(disp7);
            ...
            disp8.setCondicao("Problemas na placa de vídeo");
            disp8.setCusto(0.0);
            disp8.setPreco(0.0);
            em.persist(disp8);
            ...
            disp9.setCondicao("Tela com manchas");
            disp9.setCusto(0.0);
            disp9.setPreco(0.0);
            em.persist(disp9);
            ...
            disp10.setCondicao("Áudio não funciona");
            disp10.setCusto(0.0);
            disp10.setPreco(0.0);
            em.persist(disp10);
